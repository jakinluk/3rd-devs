...
Include all readable text, maintaining the original formatting and structure where possible. Reply in Polish language.`;
...
The answer should be factual and directly based on the provided context. Answer in Polish language.
